...
from API.blocks.conversion_utils import conversion_transfer
from API.blocks.mdf_common import MDF_Common
from API.blocks.source_utils import Source
...
class MDF4(MDF_Common):
    ...
    * ``param`` - row size used for tranposizition, in case of tranposed zipped blockss
    ...
    def append(
        ...
        >>> mdf = MDF4('new.mdf')
        >>> mdf.append([s1, s2, s3], comment='created by mdfstudioAPI v4.0.0')
        ...
        >>> sigs = [ch1, ch2]
        >>> mdf2 = MDF4('out.mf4')
        >>> mdf2.append(sigs, comment='created by mdfstudioAPI v4.0.0')
    ...
    def extend(self, index, signals):
        ...
        >>> s3 = Signal(samples=s3, timestamps=t, unit='flts', name='Floats')
        >>> mdf = MDF4('new.mdf')
        >>> mdf.append([s1, s2, s3], comment='created by mdfstudioAPI v1.1.0')
