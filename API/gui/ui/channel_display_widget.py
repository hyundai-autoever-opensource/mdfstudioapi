...
class Ui_ChannelDisplay(object):
    def setupUi(self, ChannelDiplay):
        ChannelDiplay.setObjectName("ChannelDisplay")
    ...
    def retranslateUi(self, ChannelDiplay):
        ...
        ChannelDiplay.setWindowTitle(_translate("ChannelDisplay", "Form"))
        self.name.setText(_translate("ChannelDisplay", "MAIN CLOCK"))
        self.ylink.setToolTip(_translate("ChannelDisplay", "enable common Y axis"))
